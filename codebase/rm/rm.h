...
#define INDEX_COL_ATTRIBUTE             "attr"

#define INDEX_COL_ATTR_NAME_SIZE   50

#define INDEX_RECORD_DATA_SIZE 1 + 2*INDEX_COL_ATTR_NAME_SIZE
...
private:
  ...
  void prepareIndexRecordData(const string &tblname, const string &attrName, void* data);
  ...
  RC insertIndex(const string &tbl_name, const string &attrNum);
  ...
  void fillKey(void* key, void* metakey, AttrType type);
